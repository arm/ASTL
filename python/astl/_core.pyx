...
class CollectionParameterFlags:
    NONE = ASTL_COLLECTION_PARAMETERS_FLAG_NONE
    OPTIMIZE_OVERHEAD = ASTL_COLLECTION_PARAMETERS_FLAG_OPTIMIZE_OVERHEAD
    OPTIMIZE_MEMORY = ASTL_COLLECTION_PARAMETERS_FLAG_OPTIMIZE_MEMORY
    OPTIMIZE_INTERFERENCE = ASTL_COLLECTION_PARAMETERS_FLAG_OPTIMIZE_INTERFERENCE
    NO_CACHING = ASTL_NO_CACHING
