...
static const std::unordered_map<astl_status_code, const char*> kStatusMap = {
    ...
    {ASTL_STATUS_METRIC_RECEIVED_INVALID_SAMPLE,             "METRIC_RECEIVED_INVALID_SAMPLE"            },
    {ASTL_STATUS_METRIC_OVERFLOW_DETECTED,                   "METRIC_OVERFLOW_DETECTED"                  },
    {ASTL_STATUS_SAMPLING_INTERVAL_TOO_SMALL,                "SAMPLING_INTERVAL_TOO_SMALL"               },
