...
class RawMetric : public virtual IMetric {
 public:
   ...
   */
  auto ReceiveRawSample(const RawSampledData &sample) -> astl_status_code override = 0;
 ...
 protected:
   ...
   */
  auto CheckSampleValueType(const RawSampledData &sample) const -> astl_status_code;
