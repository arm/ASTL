  ...
  if (!useNegativeRound) {
    if (val < 0) {
      return (decimalPosition == 0)
                 ...
                 : std::ceil(static_cast<te_type>(val * decimalPosition) - ROUND_EPSILON) / decimalPosition;
    }
    return (decimalPosition == 0)
               ? std::floor(val + ROUND_EPSILON)
               : std::floor(static_cast<te_type>(val * decimalPosition) + ROUND_EPSILON) / decimalPosition;
  }
  // ROUND(21.5, -1) = 20
  if (val < 0) {
...
[[nodiscard]]
static te_type te_asset_depreciation(te_type cost, te_type salvage, te_type life, te_type period, te_type month) {
  ...
  return (period == life + 1) ? ((cost - priorDepreciation) * rate * (NUM_OF_MONTHS - month)) / NUM_OF_MONTHS
...
[[nodiscard]]
static te_type te_sum(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6, te_type val7,
...
[[nodiscard]]
static te_type te_average(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6,
...
[[nodiscard]]
static te_type te_max(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6, te_type val7,
                      te_type val8, te_type val9, te_type val10, te_type val11, te_type val12, te_type val13,
                      te_type val14, te_type val15, te_type val16, te_type val17, te_type val18, te_type val19,
                      te_type val20, te_type val21, te_type val22, te_type val23, te_type val24) noexcept {
...
[[nodiscard]]
static te_type te_min(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6, te_type val7,
                      te_type val8, te_type val9, te_type val10, te_type val11, te_type val12, te_type val13,
                      te_type val14, te_type val15, te_type val16, te_type val17, te_type val18, te_type val19,
                      te_type val20, te_type val21, te_type val22, te_type val23, te_type val24) noexcept {
...
[[nodiscard]]
static te_type te_and_variadic(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6,
                               te_type val7, te_type val8, te_type val9, te_type val10, te_type val11, te_type val12,
                               te_type val13, te_type val14, te_type val15, te_type val16, te_type val17, te_type val18,
...
[[nodiscard]]
static te_type te_or_variadic(te_type val1, te_type val2, te_type val3, te_type val4, te_type val5, te_type val6,
                              te_type val7, te_type val8, te_type val9, te_type val10, te_type val11, te_type val12,
                              te_type val13, te_type val14, te_type val15, te_type val16, te_type val17, te_type val18,
                              te_type val19, te_type val20, te_type val21, te_type val22, te_type val23,
                              te_type val24) {
...
[[nodiscard]]
static te_type te_ifs(te_type if1, te_type if1True, te_type if2, te_type if2True, te_type if3, te_type if3True,
                      te_type if4, te_type if4True, te_type if5, te_type if5True, te_type if6, te_type if6True,
                      te_type if7, te_type if7True, te_type if8, te_type if8True, te_type if9, te_type if9True,
                      te_type if10, te_type if10True, te_type if11, te_type if11True, te_type if12, te_type if12True) {
...
te_expr* te_parser::base(state* theState) {
  ...
  if (theState->m_type == state::token_type::TOK_OPEN) {
    ...
    ret = new_expr(TE_DEFAULT, theState->m_value);
    next_token(theState);
  } else if (theState->m_type == state::token_type::TOK_NULL || theState->m_type == state::token_type::TOK_ERROR ||
             theState->m_type == state::token_type::TOK_END || theState->m_type == state::token_type::TOK_SEP ||
             theState->m_type == state::token_type::TOK_CLOSE || theState->m_type == state::token_type::TOK_INFIX) {
  ...
  return std::visit(
      [&, texp]<typename T0>(const T0& var) -> te_type {
        ...
        if constexpr (te_is_closure_v<T>) {
          ...
          return std::apply(
              var, make_closure_arg_list(M, texp->m_parameters[n_args - 1], std::make_index_sequence<n_args - 1>{}));
        }
