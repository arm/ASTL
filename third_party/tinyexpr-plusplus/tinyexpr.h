...
using te_variant_type =
    std::variant<te_type, const te_type*,  // indices 0-1
                 te_fun0, te_fun1, te_fun2, te_fun3, te_fun4, te_fun5, te_fun6, te_fun7, te_fun8, te_fun9, te_fun10,
                 te_fun11, te_fun12, te_fun13, te_fun14, te_fun15, te_fun16, te_fun17, te_fun18, te_fun19, te_fun20,
                 te_fun21, te_fun22, te_fun23, te_fun24, te_confun0, te_confun1, te_confun2, te_confun3, te_confun4,
                 te_confun5, te_confun6, te_confun7, te_confun8, te_confun9, te_confun10, te_confun11, te_confun12,
                 te_confun13, te_confun14, te_confun15, te_confun16, te_confun17, te_confun18, te_confun19, te_confun20,
                 te_confun21, te_confun22, te_confun23, te_confun24>;
...
class te_parser {
 public:
  ...
  void remove_variable_or_function(te_variable::name_type var) {
    const auto foundVar =
        m_customFuncsAndVars.find(te_variable{std::move(var), static_cast<te_type>(0.0), TE_DEFAULT, nullptr});
...
#undef TE_DEF_CLOSURE
  ...
  static te_expr* new_expr(const te_variable_flags type, te_variant_type value,
    ...
    ret->m_parameters.resize(std::max<size_t>(
        std::max<size_t>(parameters.size(), get_arity(ret->m_value)) + (is_closure(ret->m_value) ? 1 : 0), 0));
