...
class ResidencyMetricTestFixture : public astl::ResidencyMetric {
 public:
  ...
  astl_status_code TestUpdateStateResidencyStatistics(const std::string&        state_name,
                                                      ...
                                                      astl::ProcessedSampleTimestamp timestamp) {
  ...
  static astl::ProcessedSampleTimestamp CreateTimestamp(std::chrono::steady_clock::time_point timePoint) {
...
TEST_CASE("ResidencyMetric: deterministic processed sample sink order", "[ResidencyMetric]") {
  ...
  metric.ReceiveRawSample(
      astl::NormalizedSampledData(operations[0]->GetId(), astl::AstlValue{uint64_t{1000}}, timestamp1));
  metric.ReceiveRawSample(
      astl::NormalizedSampledData(operations[1]->GetId(), astl::AstlValue{uint64_t{500}}, timestamp1));
  metric.ReceiveRawSample(
      astl::NormalizedSampledData(operations[2]->GetId(), astl::AstlValue{uint64_t{250}}, timestamp1));
  ...
  metric.ReceiveRawSample(
      astl::NormalizedSampledData(operations[1]->GetId(), astl::AstlValue{uint64_t{525}}, timestamp2));  // C1 delta 25
  metric.ReceiveRawSample(
      astl::NormalizedSampledData(operations[2]->GetId(), astl::AstlValue{uint64_t{265}}, timestamp2));  // C2 delta 15
  // At this point not all states processed yet -> no sinking
  REQUIRE(recording_sink.values_in_order.empty());
  metric.ReceiveRawSample(astl::NormalizedSampledData(operations[0]->GetId(), astl::AstlValue{uint64_t{1050}},
...
TEST_CASE("ResidencyMetric: single sample processing", "[ResidencyMetric]") {
  ...
  astl::NormalizedSampledData c6_sample1(first_operation_id, c6_val1, timestamp1);
...
TEST_CASE("ResidencyMetric: two samples processing", "[ResidencyMetric]") {
  ...
  astl::NormalizedSampledData c6_sample2(first_operation_id, c6_val2, timestamp2);
...
TEST_CASE("ResidencyMetric: multiple states processing", "[ResidencyMetric]") {
  ...
  astl::NormalizedSampledData c1_sample1(second_operation_id, c1_val1, timestamp3);
  ...
  astl::NormalizedSampledData c1_sample2(second_operation_id, c1_val2, timestamp4);
...
TEST_CASE("ResidencyMetric: summarization", "[ResidencyMetric]") {
  ...
  astl::NormalizedSampledData c6_s1(first_operation_id, astl::AstlValue{uint64_t{1000000}},
                                    timestamp1);  // 1M ticks baseline
  ...
  astl::NormalizedSampledData c6_s2(first_operation_id, astl::AstlValue{uint64_t{2000000}},
...
TEST_CASE("ResidencyMetric: invalid samples", "[ResidencyMetric]") {
  ...
  SECTION("Invalid operation ID") {
    ...
    astl::NormalizedSampledData invalid_sample(999, invalid_val, timestamp);  // operation_id 999 doesn't exist
...
TEST_CASE("ResidencyMetric: reset functionality", "[ResidencyMetric]") {
  ...
  auto                        base_timestamp = std::chrono::steady_clock::now();
  auto                        timestamp1     = ResidencyMetricTestFixture::CreateTimestamp(base_timestamp);
  astl::NormalizedSampledData sample1(first_operation_id, astl::AstlValue{uint64_t{1000000}}, timestamp1);

  fixture.ReceiveRawSample(sample1);

  auto timestamp2 = ResidencyMetricTestFixture::CreateTimestamp(base_timestamp + std::chrono::milliseconds(10));
  astl::NormalizedSampledData sample2(first_operation_id, astl::AstlValue{uint64_t{2000000}}, timestamp2);
...
TEST_CASE("ResidencyMetric: state-specific data retrieval", "[ResidencyMetric]") {
  ...
  auto base_timestamp = std::chrono::steady_clock::now();
  auto timestamp1     = ResidencyMetricTestFixture::CreateTimestamp(base_timestamp);
  fixture.ReceiveRawSample(
      astl::NormalizedSampledData(first_operation_id, astl::AstlValue{uint64_t{1000000}}, timestamp1));
  auto timestamp2 = ResidencyMetricTestFixture::CreateTimestamp(base_timestamp + std::chrono::milliseconds(10));
  fixture.ReceiveRawSample(
      astl::NormalizedSampledData(first_operation_id, astl::AstlValue{uint64_t{2000000}}, timestamp2));

  auto timestamp3 = ResidencyMetricTestFixture::CreateTimestamp(base_timestamp + std::chrono::milliseconds(10));
  fixture.ReceiveRawSample(
      astl::NormalizedSampledData(second_operation_id, astl::AstlValue{uint64_t{500000}}, timestamp3));
  auto timestamp4 = ResidencyMetricTestFixture::CreateTimestamp(base_timestamp + std::chrono::milliseconds(20));
  fixture.ReceiveRawSample(
      astl::NormalizedSampledData(second_operation_id, astl::AstlValue{uint64_t{1000000}}, timestamp4));
...
TEST_CASE("ResidencyMetric: inferred state baseline samples", "[ResidencyMetric]") {
  ...
  auto status1 = fixture.ReceiveRawSample(
      astl::NormalizedSampledData(c6_operation_id, astl::AstlValue{uint64_t{1000}}, timestamp1));
  auto status2 = fixture.ReceiveRawSample(
      astl::NormalizedSampledData(c1_operation_id, astl::AstlValue{uint64_t{500}}, timestamp1));
  auto status3 = fixture.ReceiveRawSample(
      astl::NormalizedSampledData(c2_operation_id, astl::AstlValue{uint64_t{250}}, timestamp1));
...
TEST_CASE("ResidencyMetric: inferred state calculation when all states receive samples", "[ResidencyMetric]") {
  ...
  auto base_time  = std::chrono::steady_clock::now();
  auto timestamp1 = ResidencyMetricTestFixture::CreateTimestamp(base_time);
  fixture.ReceiveRawSample(astl::NormalizedSampledData(c6_operation_id, astl::AstlValue{uint64_t{1000}}, timestamp1));
  fixture.ReceiveRawSample(astl::NormalizedSampledData(c1_operation_id, astl::AstlValue{uint64_t{500}}, timestamp1));
  fixture.ReceiveRawSample(astl::NormalizedSampledData(c2_operation_id, astl::AstlValue{uint64_t{250}}, timestamp1));
  ...
  fixture.ReceiveRawSample(astl::NormalizedSampledData(c6_operation_id, astl::AstlValue{uint64_t{1050}}, timestamp2));

  // C1: delta = 25 ticks = 0.025 seconds (25 ticks / 1000 Hz)
  fixture.ReceiveRawSample(astl::NormalizedSampledData(c1_operation_id, astl::AstlValue{uint64_t{525}}, timestamp2));
  ...
  fixture.ReceiveRawSample(astl::NormalizedSampledData(c2_operation_id, astl::AstlValue{uint64_t{265}}, timestamp2));
